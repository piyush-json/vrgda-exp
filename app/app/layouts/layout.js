...
function Layout() {
    return (<div className='min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100' id='3aile9'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8' id='scp4bf'>
        ...
        <footer className='py-6 border-t border-gray-200 dark:border-gray-800' id='u701wj'>
