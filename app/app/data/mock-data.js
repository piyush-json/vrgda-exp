...
exports.mockTokens = void 0;
// Generate random chart data
const generateChartData = (days, trend) => {
    const data = [];
...
exports.mockTokens = [
    {
        ...
        description: "A community-driven token focused on creating a sustainable ecosystem on Solana.",
    ...
    },
    {
        ...
        description: "Aiming to revolutionize DeFi on Solana with innovative staking mechanisms.",
    ...
    },
    {
        ...
        description: "The first community-owned meme token on Solana with real utility.",
        chartData: generateChartData(24, "up"),
    },
    {
        id: "4",
        ...
        description: "Integrating AI capabilities with Solana blockchain for next-gen applications.",
    ...
    },
    {
        ...
        description: "Building the future of blockchain gaming on Solana with play-to-earn mechanics.",
        chartData: generateChartData(24, "down"),
    },
    {
        id: "6",
        ...
        description: "Decentralized finance solutions built on Solana for maximum efficiency and low fees.",
        chartData: generateChartData(24, "up"),
    },
];
